---
title: "Notes on Givewell's Cost Effectiveness Analysis on Deworming Using Spreadsheets "
...
- $\blue{P^{itram}_{3}:}$
`r colorize("costs by year, location, region, activity, and month. ", "blue")` (`F1, [r+m+y], E15:21`) 

```{r eq_6, echo=print_code}
# - inputs: nothing
# - outputs: 
...
- $\blue{ Q^{itr}_{3} }$: `r colorize("Actual treatment rounds per year. ", "blue")`  (`F1, 4, D[crt]`)
- $Q^{itrm}_{4}$: Adjustment factor (`F1, C, [rmt]25`)

```{r eq_7, echo=print_code}
# - inputs: nothing
# - outputs: 
