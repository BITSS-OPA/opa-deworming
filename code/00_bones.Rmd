...
Not sure why this part renders weirdly...

```{r comp3,  echo=print_code, eval=FALSE}
# - inputs: factors of q
# - outputs: q value
chunk_k <- function(){
###############################################################################
...
```{r all-steps,  echo=print_code, eval = FALSE}
#unit test function
...
```{r main-results,  echo=print_code, eval = FALSE}
...
```{r mc-setup,  echo=print_code, eval = FALSE}
...
```{r mc-run, echo = print_code, eval = FALSE}
