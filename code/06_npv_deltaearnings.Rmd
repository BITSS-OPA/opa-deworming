...
|--------------------------------:|------------------:|-----------------------------------:|-----------------------------------------------:|---------------------------------------:|-----------------------------------------:|
|                                                                                                                                                                                                  
|                                 |40 years           |0                                   |                                                |10%                                     |**`r round(l1_social_persist_int10,2)`**  |
|                                 |40 years           |0                                   |                                                |`r 100*interest_in`%                    |**`r round(l1_social_persist_realint,2)`**|
|                                 |25 years           |0                                   |                                                |10%                                     |**`r round(l1_social_die_int10,2)`**      |
|                                 |25 years           |0                                   |                                                |`r 100*interest_in`%                    |**`r round(l1_social_die_realint,2)`**    |
|                                 |40 years           |                                    |0                                               |10%                                     |**`r round(l1_tax_persist_int10,2)`**     |
|                                 |40 years           |                                    |0                                               |`r 100*interest_in`%                    |**`r round(l1_tax_persist_realint,2)`**   |
|                                 |25 years           |                                    |0                                               |10%                                     |**`r round(l1_tax_die_int10,2)`**         |
|                                 |25 years           |                                    |0                                               |`r 100*interest_in`%                    |**`r round(l1_tax_die_realint,2)`**       |
|                                                                                                                                                                                                   
|                                 |40 years           |0                                   |                                                |**`r 100*round(irr_social_persist,3)`%**|`r round(mean(lambda1_so), 2)`            |
|                                 |40 years           |                                    | 0                                              |**`r 100*round(irr_tax_persist,3)`%**   |`r round(mean(lambda1_so), 2)`            |
|                                 |25 years           |0                                   |                                                |**`r 100*round(irr_social_die,3)`%**    |`r round(mean(lambda1_so), 2)`            |
|                                 |25 years           |                                    | 0                                              |**`r 100*round(irr_tax_die,3)`%**       |`r round(mean(lambda1_so), 2)`            |
|
| 10%                             |40 years           |**`r round(npv_int10_persist,0)`**  |**`r round(tax_int10_persist,0)`**              |                                        |`r round(mean(lambda1_so), 2)`            |
|`r 100*interest_in`%             |40 years           |**`r round(npv_realint_persist,0)`**|**`r round(tax_realint_persist,0)`**            |                                        |`r round(mean(lambda1_so), 2)`            |
| 10%                             |25 years           |**`r round(npv_int10_die,0)`**      |**`r round(tax_int10_die,0)`**                  |                                        |`r round(mean(lambda1_so), 2)`            |
|`r 100*interest_in`%             |25 years           |**`r round(npv_realint_die,0)`**    |**`r round(tax_realint_die,0)`**                |                                        |`r round(mean(lambda1_so), 2)`            |
Note:
