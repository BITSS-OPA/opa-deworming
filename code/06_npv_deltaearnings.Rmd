...
|        |                                 |25 years            |                                    |0                                               |5%               |**X**                             |
|PANEL B                                                                                                                                                                                                   
|        |                                 |40 years            |0                                   |                                                |**`r round(irr_social_persist,1)`**        |`r round(mean(lambda1_so), 2)`    |
|        |                                 |40 years            |                                    | 0                                              |**26.7%**        |`r round(mean(lambda1_so), 2)`    |
|        |                                 |25 years            |0                                   |                                                |**54.2%**        |`r round(mean(lambda1_so), 2)`    |
|        |                                 |25 years            |                                    | 0                                              |**26.3%**        |`r round(mean(lambda1_so), 2)`    |
|PANEL C                                                                                                                                                                                           |
