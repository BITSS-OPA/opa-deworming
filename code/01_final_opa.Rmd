...
-   $F_{t}$: the number of children one individual bears $t$ years after the deworming intervention\
-   $V$: the total number of childbirth per KLPS participant in 2021\
-   $V_{t}$: the number of childbirth  in year t  (CHANGE NOTATION)\
