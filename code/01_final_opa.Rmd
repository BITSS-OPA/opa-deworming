...
The actual value varies across approaches depending on the time and country chosen. For example approach 1 uses the return from government bonds and the inflation rate in Kenya for the year 2016, while approaches 2 and 3 use the values for the same country for the year 2019. This results in discount rates of `r paste(round(100 * interest_in,2), "%", sep="")` and `r paste(round(100 * interest_new_in,2), "%", sep="")` for approach 1 and, 2 and 3 respectively.
