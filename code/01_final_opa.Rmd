...
The cost for approahc for follow the costs of @klps5 (which adopts the direct deworming costs under @baird2016worms, \$`r format(round(s2_new_in * q2_in,2), nsmall = 2)` (2017 USD PPP), `r round(years_of_treat_0_so,1)` years of treatment, and take-up rate of `r format(round(q2_in,2), nsmall = 2)`).
