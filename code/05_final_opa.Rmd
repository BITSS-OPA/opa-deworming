...
table_1[12,2] <- paste0("$r_{19}=", interest_19, "$")
...
table_1[13,1] <- paste0("$\\overline{{C}_{i}}=", round(costs1_p2_f(country_w_var = costs1_p1_in$country_w, country_cost_var = costs1_p1_in$per_cap), 2), "$") #weighted average
table_1[14,1] <- paste0("$\\overline{{N}_{i}}=", mean(costs1_p1_in$total), "$")

table_1 <- rbind(table_1,
                 c("", paste0("$\\eta=", alpha_0_so, "$"), ""), #change to eta
                 c("", paste0("$\\eta_{r}=", alpha_r_so, "$"), ""))
