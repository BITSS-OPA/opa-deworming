...
**So we get an average cost of deworming each child over the entire treatment period, $`r format(round(sum( ( 1 / (1 + interest) )^(0:2) * (s2_in * q2_in) ),2), nsmall = 2)`.**
...
**Then we get an average cost of additional schooling per child over the nine-year period, $`r format(round((cost_per_student_in*sum( (1/(1+interest))^(0:8) * delta_ed_in )),2), nsmall = 2)`.**
