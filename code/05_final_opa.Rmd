...
npv_sim_all <-   sim.data1(
            nsims = nsims_so,                        
            gov_bonds_var2          = round(gov_bonds_so,2)            ,     #rounded to match shiny app                                
            ...
            prevalence_0_var2_sd    = 0.1    ,                      # changed to match shiny app
            prevalence_r_var2       = 1       ,                     # TEMP
            prevalence_r_var2_sd    = 0.1    ,           
            new_prev_r_var2         = round(prevalence_r_in,2),     # changed to match shiny app
            new_prev_r_var2_sd      = 0.1,                          # changed to match shiny appp
            ...
            new_costs_var2          = round(costs2_ea_in,2),        # rounded to match shiny app 
            new_costs_var2_sd       = round(costs2_ea_in,2) * 0.1,  # rounded to match shiny app 
