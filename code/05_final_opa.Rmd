...
```{r, eval=FALSE}
  function(periods_var = periods_so, delta_ed_var = delta_ed_final_in,
...
################################################################################  
    ...
    wage_t_mo <- wage_t_mo_f(wage_0_var = wage_0_mo,
                       ...
                       experience_var =  0:periods_so - time_to_jm_so,
...
# NPV <-- pv_benf <-- earnings1 <-- wage_t_mo_f <-- wage_0_mo_f
#           ↑_____interest 	 
NPV_pe(benefits_var =
  pv_benef(
    earnings_var = earnings1(
      wage_var = wage_t_mo_f(
        wage_0_var = wage_0_mo_f(
          wage_ag_var = wage_ag_so,  
          wage_ww_var = wage_ww_so,
          profits_se_var = profits_se_so,
          hours_se_cond_var = hours_se_cond_so,  
          hours_ag_var = hours_ag_so,
      ...
      lambda1_var = lambda1_so,
      lambda2_var = lambda2_so,
      saturation_var = as.numeric( saturation_in_f() ),
      coverage_var = coverage_so),
    interest_r_var = as.numeric( interest_f() ),
    periods_var = periods_so), 
  costs_var = 11.63818)
```
