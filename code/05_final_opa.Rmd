...
sum_table_index <- sum_table_index+1
table_2 <- rbind(table_2,
                 c("$E_t = \\mathbf{1}(10 \\lt t \\leq 15)\\alpha^{KLPS2} + \\mathbf{1}(15 \\lt t \\leq 20)\\alpha^{KLPS3} + \\mathbf{1}(t \\gt 20)\\alpha^{KLPS4}$",
                   paste0("$(", sum_table_index, ")$") )
    )
...
table_1[12,1] <- paste0("$\\overline{{C}_{i}}=", round(costs1_p2_f(country_w_var = costs1_p1_in$country_w, country_cost_var = costs1_p1_in$per_cap), 2), "$") #weighted average
...
sim.data1 <- function(nsims = 1e2,
    ...
    # TO DO: modify to have a scalar multlying the series, and have that scalar being N(1,0.1)
    ...
    # modify to have a scalar multlying the series, and have that scalar being N(1,0.1)
