...
###############################################################################  
    ...
    country_sel_pop_so <- c("india" = 1.366417750*1e9, "kenya" = 5.257397 * 1e7, "nigeria" = 2.0096360 * 1e8, "vietnam" = 9.646211 * 1e7) 
...
```{r main-pe-print, out.width = '70%', fig.align='center', fig.cap="Main Policy Estimate", echo=FALSE, purl=FALSE}
# url
...
###############################################################################    
    ...
    lambda_eff_f <- function(lambda1_var = lambda1_in_f(), 
      ...
      prevalence_temp <- prevalence_r_so * 
