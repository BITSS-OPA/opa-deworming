...
##-------------- Inputs for costs1_f--------------------------------------------
    if (run_sim_var == TRUE) {
        costs1_country <-  costs1_ratios_in_f(counts_var = costs1_counts_sim, costs_var =  costs1_costs_sim)
    } else {
    ...
    return( list( "wage_0_in" = wage_0_in, "wage_t_in" = wage_t_in, "lambda1_in" = lambda1_in, 
          ...
          "earnings_in_yes_ext" = earnings_in_yes_ext, "earnings_in_no_ext_new" = earnings_in_no_ext_new, 
...
interest_in <- as.numeric( interest_f(gov_bonds_var = gov_bonds_so, 
