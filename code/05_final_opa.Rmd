...
```{r main-pe-print, out.width = '70%', fig.align='center', fig.cap="Main Policy Estimate", echo=FALSE}
# url
...
# Emma: update all tables bellow with new formulat for r. 


knitr::kable(table_2, col.names = c("Equation", "#"), caption = "Summary of equations use until this point in the document") %>%
...
table_1[1,2] <- paste0("$p=" , NA, "$")
table_1[2,2] <- paste0("$R=" , NA, "$")
table_1[3,2] <- paste0("$\\lambda_1=" , NA, "$")
table_1[4,2] <- paste0("$\\lambda_2=" , NA, "$")

table_1 <-rbind(table_1, 
                c( "", paste0("$\\hat{\\beta}_1=" , NA, "$"), ""), 
                c( "", paste0("$\\hat{\\beta}_2=" , NA, "$"), "") )

table_1[5,1] <- paste0("$w_l=" , NA, "$") 
table_1[6,1] <- paste0("$w_{ww}=" , NA, "$") 
