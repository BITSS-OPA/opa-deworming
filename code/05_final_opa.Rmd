...
Benefits are represented by the discounted sum of gains in earnings over time, characterized by the real interest rate r.
...
```{r sum_tables1, purl=FALSE, echo=FALSE}
...
knitr::kable(table_1, col.names = c("Data", "Research", "Guesswork"), caption = "Sources: summary of inputs")
...
```{r sum_tables2, purl=FALSE, echo=FALSE}

table_1[1,1] <- paste0("$\\pi=" , inflation_so, "$")

table_1 <- rbind(table_1,
                 c( paste0("$g=" , gov_bonds_so, "$"),  "", "" )
    )
...
Gains in earnings ($E_t$) are the product of earnings in a certain period and the combined direct and indirect effects of deworming on earnings. The indirect effects are considered within the context of the treatment's coverage and saturation.
...
```{r sum_tables3, purl=FALSE, echo=FALSE, eval=TRUE}

table_3 <- matrix("", nrow = 1, ncol = 3)

table_3[1,1] <- paste0("$E_t=" , NA, "$")

table_3 <- rbind(table_3,
                 c(paste0("$w_t=" , NA, "$"),
                 paste0("$p=" , NA, "$"),  paste0("$R=" , NA, "$") ))

table_3[1,2] <- paste0("$\\lambda_1=" , NA, "$")


table_3[1,3] <- paste0("$\\lambda_2=" , NA, "$")


sum_table_index <- sum_table_index+1
table_2 <- rbind(table_2,
                 c("$E_t = w_{t}\\left( \\lambda_{1} + \\frac{p \\lambda_{2}}{R} \\right)$",
                   paste0("$(", sum_table_index, ")$") )
    )

knitr::kable(table_3, col.names = c("Data", "Research", "Guesswork"), caption = "Sources: summary of inputs")
knitr::kable(table_2, col.names = c("Equation", "#"), caption = "Model: summary of equations")
```
...
<details><summary>View Summary Table</summary>
```{r sum_tables4, purl=FALSE, echo=FALSE, eval=TRUE}
...
```{r sum_tables5, purl=FALSE, echo=FALSE, eval=TRUE}

table_4 <- matrix("", nrow = 1, ncol = 3)

table_4[1,1] <- paste0("$w_t=" , NA, "$")

table_4 <- rbind(table_4,
                 c(paste0("$w_0=" , NA, "$")," ",  
                   paste0("$\\hat{\\beta}_2=" , NA, "$")))

table_4[1,2] <- paste0("$X_p=" , NA, "$")

table_4[1,3] <- paste0("$\\hat{\\beta}_1=" , NA, "$")
table_4 <- rbind(table_4, c(paste0("$g=" , NA, "$"), "    ",
                            "    "))

knitr::kable(table_4, col.names = c("Data", "Research", "Guesswork"), caption = "Sources: summary of inputs")
```
...
<details><summary>View Summary Table</summary>
```{r sum_tables6, purl=FALSE, echo=FALSE, eval=TRUE}
...
```{r sum_tables7, purl=FALSE, echo=FALSE, eval=TRUE}

table_5 <- matrix("", nrow = 1, ncol = 3)

table_5[1,1] <- paste0("$w_l=" , NA, "$")

table_5 <- rbind(table_5,
                 c(paste0("$\\alpha_l=" , NA, "$"),
                   paste0("$w_{se}=" , NA, "$"),  
                   paste0("$h_l=" , NA, "$")))

table_5[1,2] <- paste0("$h_{ag}=" , NA, "$")

table_5[1,3] <- paste0("$h_{ww}=" , NA, "$")
table_5 <- rbind(table_5, c(paste0("$h_{se}=" , NA, "$"),
                            "   ",
                            "    "))

knitr::kable(table_5, col.names = c("Data", "Research", "Guesswork"), caption = "Sources: summary of inputs")
```
...
$\lambda_{2,\gamma}$ the estimated externality effect (EXPLAIN) and comes from research (W\@W). Note that this parameter is not estimated by gender, so we repeat its value two times. All the components to the equation \\ref{eq:`r equationIndex`} come from @baird2016worms.

<details><summary>View Summary Table</summary>
```{r sum_tables8, purl=FALSE, echo=FALSE, eval=TRUE}
...
```{r sum_tables9, purl=FALSE, echo=FALSE, eval=TRUE}

table_6 <- matrix("", nrow = 1, ncol = 3)

table_6[1,1] <- "    "

table_6[1,3] <- paste0("$\\lambda_1=" , NA, "$")
table_6 <- rbind(table_6, c("    ",
                            "    ",
                            paste0("$\\lambda_{1, male}=", NA, "$")))

table_6 <- rbind(table_6, c("    ",
                            "    ",
                            paste0("$\\lambda_{1, female}=", NA, "$")))

knitr::kable(table_6, col.names = c("Data", "Research", "Guesswork"), caption = "Sources: summary of inputs")
```
</details>
...
The coverage, $R$, is defined as the fraction, among all neighboring schools (within 6 km), that belongs to the treatment group^[6]. As the treatment was applied to approximately two thirds of the population, $R$ is set to: $R  = `r round(coverage_so, 2)`$.  
...
For this (or similar?) setting Miguel and Kremer 2007 [add page, table, col, row] estimate that there is almost no take-up without subsidy, hence $Q(0)$ is assigned the value of `r q_zero_so`. The same article [add page, table, col, row] estimates that take-up with full subsidy is $Q(full) = `r q_full_so`$.

<details><summary>View Summary Table</summary>
```{r sum_tables10, purl=FALSE, echo=FALSE, eval=TRUE}
...
```{r sum_tables11, purl=FALSE, echo=FALSE, eval=TRUE}

table_7 <- matrix("", nrow = 1, ncol = 3)

table_7[1,1] <- paste0("$p=" , NA, "$")

table_7[1,2] <- paste0("$Q(full)=" , 0.75, "$")
table_7 <- rbind(table_7, c(paste0("$R=" , 0.68, "$"),
                            paste0("$Q(0)=" , 0, "$"),
                            "    "))

knitr::kable(table_7, col.names = c("Data", "Research", "Guesswork"), caption = "Sources: summary of inputs")
```
</details>
...
```{r sum_tables12, purl=FALSE, echo=FALSE, eval=TRUE}

table_8 <- matrix("", nrow = 1, ncol = 3)

table_8[1,1] <- paste0("$C=" , NA, "$")
table_8[1,2] <- paste0("$S_2=" , NA, "$")
table_8[1,3] <- paste0("$Q=" , NA, "$")

table_8 <- rbind(table_8, c(paste0("$S_1=" , NA, "$"),
                            paste0("$K=" , NA, "$"),
                            paste0("$r=" , NA, "$")))
table_8 <- rbind(table_8, c(paste0("$r=", NA, "$"),
                            paste0("$t=" , NA, "$"),
                            paste0("$\\Delta \\bar{E}_t=" , NA, "$")))
sum_table_index <- sum_table_index+1
table_2 <- rbind(table_2,
                 c("$C =  \\left( S_{2}Q(S_{2}) - S_{1}Q(S_{1}) \\right) + K \\sum_{t=0}^{50} \\left( \\frac{1}{1 + r}\\right)^{t} \\Delta \\overline{E}_{t}(S1,S2)$",
                   paste0("$(", sum_table_index, ")$") )
    )

knitr::kable(table_8, col.names = c("Data", "Research", "Guesswork"), caption = "Sources: summary of inputs")
```
</details>
...
<details><summary>View Summary Table</summary>
```{r sum_tables13, purl=FALSE, echo=FALSE, eval=TRUE}

sum_table_index <- sum_table_index+1
table_2 <- rbind(table_2,
                 c("$DC = S_{2}Q(S_{2}) - S_{1}Q(S_{1})$",
                   paste0("$(", sum_table_index, ")$") )
    )
...
<details><summary>View Summary Table</summary>
```{r sum_tables14, purl=FALSE, echo=FALSE, eval=TRUE}

sum_table_index <- sum_table_index+1
table_2 <- rbind(table_2,
                 c("$S_{2} = \\frac{\\text{Cost per person per year (KSH)}	}{ex}\\times \\text{Additional years of treatment}$",
                   paste0("$(", sum_table_index, ")$") )
    )
...
```{r sum_tables15, purl=FALSE, echo=FALSE, eval=TRUE}

table_9 <- matrix("", nrow = 1, ncol = 3)

table_9[1,1] <- paste0("$DC=" , NA, "$")
table_9[1,2] <- paste0("$S_2=" , NA, "$")
table_9[1,3] <- paste0("$Q=" , NA, "$")

table_9 <- rbind(table_9, c(paste0("$S_1=" , NA, "$"),
                            paste0("$KSH=" , NA, "$"),
                            paste0("$ex=" , NA, "$")))
table_9 <- rbind(table_9, c(paste0("$Q_2=", NA, "$"),
                            "    ",
                            "    "))

knitr::kable(table_9, col.names = c("Data", "Research", "Guesswork"), caption = "Sources: summary of inputs")
```
</details>
...
Without externalities, they obtain total NPV of benefits of `r df_research_so$param[1]`, with `r df_research_so$param[2]` in tax revenue for government (table `r df_research_so$tablenum[1]`, column `r df_research_so$table_col[1]`, and rows `r paste0(df_research_so$table_row[1], ", ", df_research_so$table_row[2])` respectively).

Including externalities, they obtain total NPV of benefits of `r df_research_so$param[3]`, with `r df_research_so$param[4]` in tax revenue for government (table `r df_research_so$tablenum[3]`, column `r df_research_so$table_col[3]`, and rows `r paste0(df_research_so$table_row[3], ", ", df_research_so$table_row[4])` respectively).
</details>
...
<details><summary>View Summary Table</summary>
```{r sum_tables16, purl=FALSE, echo=FALSE, eval=TRUE}
...
```{r sum_tables17, purl=FALSE, echo=FALSE, eval=TRUE}

table_10 <- matrix("", nrow = 1, ncol = 3)

table_10[1,1] <- paste0("$E_t=" , NA, "$")
table_10[1,2] <- paste0("$t=" , NA, "$")
table_10[1,3] <- paste0("$\\alpha^{KLPS2}=" , NA, "$")

table_10 <- rbind(table_10, c(paste0("$\\alpha^{KLPS3}=" , NA, "$"),
                            paste0("$\\alpha^{KLPS4}=" , NA, "$"),
                            "    "))

knitr::kable(table_10, col.names = c("Data", "Research", "Guesswork"), caption = "Sources: summary of inputs")
```
</details>
<details><summary>View Summary Table</summary>
```{r sum_table14, purl=FALSE, echo=FALSE, eval=TRUE}

sum_table_index <- sum_table_index+1
table_2 <- rbind(table_2,
                 c("$E_t = \\mathbf{1}(10 \\text{<} t \\leq 15)\\alpha^{KLPS2} + \\mathbf{1}(15 \\text{<} t \\leq 20)\alpha^{KLPS3} + \\mathbf{1}(t \\text{>} 20)\\alpha^{KLPS4}$",
                   paste0("$(", sum_table_index, ")$") )
    )
...
\begin{equation}
DC = \sum_{t=0}^{`r round(years_of_treat_so,1)-1`} \left( \frac{1}{1 + r}\right)^{t} \big[S_{2}Q(S_{2}) - S_{1}Q(S_{1}) \big]
`r equationIndex <- equationIndex + 1`
\label{eq:`r equationIndex`}
\tag{`r equationIndex`}
\end{equation}
...
Adding all indirect cost, the average cost of deworming each child over the entire treatment period is $`r format(round(s2_in * q2_in,2), nsmall = 2)`.
<!-- Add fold/unfold for tables -->
<details><summary>Click Here to View Analysis Table</summary>

```{r sum_tables18, purl=FALSE, echo=FALSE, eval=TRUE}

table_11 <- matrix("", nrow = 1, ncol = 3)

table_11[1,1] <- paste0("$DC=" , NA, "$")
table_11[1,2] <- paste0("$r=" , NA, "$")
table_11[1,3] <- paste0("$S_2=" , NA, "$")

table_11 <- rbind(table_11, c(paste0("$Q=" , NA, "$"),
                            paste0("$S_1=" , NA, "$"),
                            "    "))

knitr::kable(table_11, col.names = c("Data", "Research", "Guesswork"), caption = "Sources: summary of inputs")
```
</details>
<details><summary>View Summary Table</summary>
```{r sum_table15, purl=FALSE, echo=FALSE, eval=TRUE}

sum_table_index <- sum_table_index+1
table_2 <- rbind(table_2,
                 c("$DC = \\sum_{t=0}^{`r round(years_of_treat_so,1)-1`} \\left( \\frac{1}{1 + r}\\right)^{t} \\big[S_{2}Q(S_{2}) - S_{1}Q(S_{1}) \\big]$",
                   paste0("$(", sum_table_index, ")$") )
    )
sum_table_index <- sum_table_index+1
table_2 <- rbind(table_2,
...
The cost per student ($K$) is updated with new information on annual teacher salary (including benefits)[^9], $`r format(round(teach_sal_2017usdppp_so,0), scientific=FALSE)` (also adjusted for PPP), and same number of average number of students per teacher (`r n_students_so`).
...
```{r sum_tables19, purl=FALSE, echo=FALSE, eval=TRUE}

table_12 <- matrix("", nrow = 1, ncol = 3)

table_12[1,1] <- paste0("$K=" , NA, "$")
table_12[1,2] <- paste0("$r=" , NA, "$")
table_12[1,3] <- paste0("$t=" , NA, "$")

table_12 <- rbind(table_12,c(paste0("$\\Delta \\bar{E}_t=", NA, "$"),
                            paste0("$S_1=" , NA, "$"),
                            paste0("$S_2=" , NA, "$")))

knitr::kable(table_12, col.names = c("Data", "Research", "Guesswork"), caption = "Sources: summary of inputs")
```
</details>


<details><summary>View Summary Table</summary>
```{r sum_tables20, purl=FALSE, echo=FALSE, eval=TRUE}
...
```{r sum_tables21, purl=FALSE, echo=FALSE, eval=TRUE}

table_13 <- matrix("", nrow = 1, ncol = 3)

table_13[1,1] <- paste0("$N_i=" , NA, "$")
table_13[1,2] <- paste0("$Ex_i=" , NA, "$")
table_13[1,3] <- paste0("$k=" , NA, "$")

table_13 <- rbind(table_13,c(paste0("$l=", NA, "$"),
                            "    ",
                            "    "))

knitr::kable(table_13, col.names = c("Data", "Research", "Guesswork"), caption = "Sources: summary of inputs")
```
</details>
<details><summary>View Summary Table</summary>
```{r sum_table18, purl=FALSE, echo=FALSE, eval=TRUE}
...
```{r sum_tables22, purl=FALSE, echo=FALSE, eval=TRUE}

table_14 <- matrix("", nrow = 1, ncol = 3)

table_14[1,1] <- paste0("$\\alpha=" , NA, "$")
table_14[1,2] <- paste0("$\\lambda_{1}^{eff}=" , NA, "$")

knitr::kable(table_14, col.names = c("Data", "Research", "Guesswork"), caption = "Sources: summary of inputs")
```
</details>
<details><summary>View Summary Table</summary>
```{r sum_table20, purl=FALSE, echo=FALSE, eval=TRUE}
...
```{r sum_tables23, purl=FALSE, echo=FALSE, eval=TRUE}

table_15 <- matrix("", nrow = 1, ncol = 3)

table_15[1,1] <- paste0("$C=" , NA, "$")
table_15[1,2] <- paste0("$B=" , NA, "$")
table_15[1,3] <- paste0("$F_0=" , NA, "$")

knitr::kable(table_15, col.names = c("Data", "Research", "Guesswork"), caption = "Sources: summary of inputs")
```
</details>

<details><summary>View Summary Table</summary>
```{r sum_table21, purl=FALSE, echo=FALSE, eval=TRUE}
