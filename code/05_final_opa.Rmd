...
list.of.packages <- c("tidyverse", "here", "kableExtra", "readxl","plotly", 
                      "bookdown", "rootSolve","shinyBS", "shinythemes", "hrbrthemes", "ggplot2")
...
rescale <- rescale_so
    ...
    plot1 <- ggplot() +
      ...
      geom_vline(xintercept = c(0, median(npv_sim)), col=c("black", "darkblue"), lwd = c(0.8, 0.6), linetype = c("solid", "dashed") ) +
      ...
      theme_ipsum(plot_title_size = 14, axis_title_size = 12, axis_title_just = "center")
    if (rescale == TRUE) {
