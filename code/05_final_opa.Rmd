...
Over this nine year period, treated students attended school for an additional `r round(sum(delta_ed_so[,1]),2)` years on average. Then we get an average cost of additional schooling per child over the nine-year period, $`r format(round((cost_per_student_new_in*sum( (1/(1+interest_new_in))^(0:8) * delta_ed_in )),2), nsmall = 2)`.
...
|---------|-------------------------------------------------|--------------------------------|----------|
| 1.1 | @baird2016worms w/tax and no externalities (no ext) |  Treatment, Education          | `r round(a1_tax_pe, 1)`   |
| 1.2 | @baird2016worms w/t and ext                         |    Treatment, Education (w/ext)| `r round(a1_x_tax_pe, 1)` |
| 1.3 | @baird2016worms  all and no ext                     |  Treatment, Education          | `r round(a1_all_pe, 1)`   |
| 1.4 | @baird2016worms all and ext                         |  Treatment, Education (w/ext)  | `r round(a1_x_all_pe, 1)` |
| 2.1 | @klps4  w/t and no ext                              |  Treatment, Education          | `r round(klps4_1_pe, 1)`  |
| 2.2 | @klps4  all and no ext                              |  Treatment, Education          | `r round(klps4_2_pe, 1)`  |
