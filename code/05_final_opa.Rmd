...
```{r alternative-run-mc, dpi = 400, purl = FALSE, echo = FALSE}
npv_sim_all <- generate_data_f(
            nsims_var3 = nsims_so,                        
            gov_bonds_var3          = round(gov_bonds_so,2)            ,   #rounded to match shiny app                                   
            gov_bonds_var3_sd       = gov_bonds_so * 0.1          ,                                 
            inflation_var3          = inflation_so             ,                                    
            inflation_var3_sd       = inflation_so * 0.1          ,                                 
            gov_bonds_new_var3      = gov_bonds_new_so      ,          
            gov_bonds_new_var3_sd   = gov_bonds_new_so * 0.1,          
            inflation_new_var3      = inflation_new_so      ,        
            inflation_new_var3_sd   = inflation_new_so * 0.1,          
            wage_ag_var3            = wage_ag_so               ,                                      
            wage_ag_var3_sd         = wage_ag_so * 0.1            ,                                   
            wage_ww_var3            = wage_ww_so               ,                                      
            wage_ww_var3_sd         = wage_ww_so * 0.1            ,                                   
            profits_se_var3         = profits_se_so            ,                                   
            profits_se_var3_sd      = profits_se_so * 0.1         ,                                
            hours_se_cond_var3      = hours_se_cond_so         ,                                
            hours_se_cond_var3_sd   = hours_se_cond_so * 0.1      ,                             
            hours_ag_var3           = hours_ag_so              ,                                     
            hours_ag_var3_sd        = hours_ag_so * 0.1           ,                                  
            hours_ww_var3           = hours_ww_so              ,                                     
            hours_ww_var3_sd        = hours_ww_so * 0.1           ,                                  
            hours_se_var3           = hours_se_so              ,                                     
            hours_se_var3_sd        = hours_se_so * 0.1           ,                                  
            ex_rate_var3            = ex_rate_so               ,                                      
            ex_rate_var3_sd         = ex_rate_so * 0.1            ,                                   
            growth_rate_var3        = growth_rate_so           ,                                  
            growth_rate_var3_sd     = growth_rate_so * 0.1        ,
            coverage_var3           = coverage_so              ,
            coverage_var3_sd        = coverage_so * 0.1           ,  
            tax_var3                = tax_so                   ,                                             
            tax_var3_sd             = tax_so * 0.1                ,                                        
            unit_cost_local_var3    = unit_cost_local_so       ,                                     
            unit_cost_local_var3_sd = unit_cost_local_so * 0.1    ,
            unit_cost_local_new_var3 = unit_cost_2017usdppp_so,
            unit_cost_local_new_var3_sd = unit_cost_2017usdppp_so * 0.1  ,  
            years_of_treat_0_var3   = years_of_treat_0_so        ,    
            years_of_treat_0_var3_sd= years_of_treat_0_so * 0.1     ,
            years_of_treat_t_var3   = years_of_treat_t_so        ,    
            years_of_treat_t_var3_sd= years_of_treat_t_so * 0.1     ,
            lambda1_var3            = lambda1_so,                                          
            lambda1_var3_sd         = lambda1_sd_so   ,                                          
            lambda2_var3            = lambda2_so      ,                         
            lambda2_var3_sd         = lambda2_sd_so   ,                      
            q_full_var3             = q_full_so         ,                          
            q_full_var3_sd          = q_full_so * 0.1   ,                         
            coef_exp_var3           = coef_exp_so,                      
            teach_sal_var3          = teach_sal_so         ,                                          
            teach_sal_var3_sd       = teach_sal_so * 0.1      ,                                       
            teach_ben_var3          = teach_ben_so         ,                                          
            teach_ben_var3_sd       = teach_ben_so * 0.1      ,                                       
            teach_sal_new_var3      = teach_sal_new_so         ,          #add to app                                
            teach_sal_new_var3_sd   = teach_sal_new_so * 0.1      ,       #add to app                                
            teach_ben_new_var3      = teach_ben_new_so         ,          #add to app                               
            teach_ben_new_var3_sd   = 0.000001      ,                     #add to app
            n_students_var3         = n_students_so        ,                                         
            n_students_var3_sd      = n_students_so * 0.1     ,                                      
            delta_ed_var3           = delta_ed_par_so          ,                                           
            delta_ed_var3_sd        = delta_ed_par_so * 0.1       ,                                            
            delta_ed_ext_var3       = delta_ed_ext_par_so      ,                                           
            delta_ed_ext_var3_sd    = delta_ed_ext_par_so * 0.1   ,                                              
            q_zero_var3             = q_zero_so            ,                                             
            q_zero_var3_sd          = q_zero_so * 0.1         ,
            lambda1_new_var3        = lambda1_new_so,                       
            lambda1_new_var3_sd     = lambda1_new_sd_so,             
            prevalence_0_var3       = prevalence_0_so ,  
            prevalence_0_var3_sd    = 0.1    ,   # changed to match shiny app
            prevalence_r_var3       = 1       ,    #TEMP
            prevalence_r_var3_sd    = 0.1    ,           
            new_prev_r_var3         = round(prevalence_r_in,2), # changed to match shiny app
            new_prev_r_var3_sd      = 0.1, 
            staff_time_var3         = staff_time_so    ,
            staff_time_var3_sd      = staff_time_so * 0.1,
            counts_par_var3         = counts_par_so    ,
            counts_par_var3_sd      = counts_par_sd_so ,
            costs_par_var3          = costs_par_so     ,
            costs_par_var3_sd       = costs_par_sd_so,
            new_costs_var3          = round(costs2_ea_in,2),  #rounded to match shiny app 
            new_costs_var3_sd       = round(costs2_ea_in,2) * 0.1,  #rounded to match shiny app 
...
npv_sim_all <-   sim.data1(
            ...
            lambda1_new_var2        = lambda1_new_so,    #rounded to match shiny app                   
            ...
            new_prev_r_var2_sd      = new_prevalence_r_so * 0.1,
            ...
            new_costs_var2          = costs2_ea_in,
            new_costs_var2_sd       = costs2_ea_in * 0.1,
...
plot1 <- ggplot() +
  ...
  geom_vline(
    xintercept = c(0, median(npv_sim)),
    col = c("#0c2847", "darkblue"),
    lwd = c(0.8, 0.6),
    linetype = c("solid", "dashed")
  ) +
  coord_cartesian(xlim = c(-300,1000),  ylim =  c( 0, 1.2 ))  +
  guides(alpha = "none", colour="none") +
  labs(y = NULL,
       x = "Net Present Value (Benefits -  Costs)" ,
       title = "Net Lifetime Income Effects of Deworming for Each Treated Children",
  ...
  theme(
    ...
    axis.text.y = element_blank(),
    axis.line.x = element_line(color = "#0c2847", size = 0.8),
    panel.background = element_blank(),
...
if (rescale == TRUE) {
  plot1 <- suppressMessages(
    plot1 +
      coord_cartesian(xlim =  c( quantile(npv_sim, 0.01),
                                 quantile(npv_sim, 0.99) ),
                      ylim =  c( 0, 1.2 )
                      )
    )
}
