...
table_1 <- rbind(table_1,
                 c("", paste0("$\\overline{{C}_{i}}=", NA, "$"), ""),
                 c("", paste0("$\\overline{{N}_{i}}=", NA, "$"), ""),
                 c("", paste0("$\\lambda^{eff}_{1}=", NA, "$"), "")) #add alpha here?
...
table_1 <- rbind(table_1,
                 c("", paste0("$F_{0}=", NA, "$"))) #should average benefits and costs be included in summary table?
sum_table_index <- sum_table_index+1
table_2 <- rbind(table_2,
