...
**Then we get an average cost of additional schooling per child over the nine-year period, $`r format(round((cost_per_student_in_new*sum( (1/(1+interest_19))^(0:8) * delta_ed_in )),2), nsmall = 2)`.**
