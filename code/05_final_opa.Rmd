...
table_1[5,1] <- paste0("$w_l=" , NA, "$") #remove this
table_1[6,1] <- paste0("$w_{ww}=" , wage_ww_so, "$") # round; shift up to [5,1]
#need a [6,1] before using rbind below?

table_1 <-rbind(table_1,
                c( paste0("$w_{se}=" , round(profits_se_so / (4.5 * hours_se_cond_so),2), "$"), "", ""), #do i have to calculate this? copied from 589 in wage_0_mo fn but wage_se is never calculated outside the fn
                c( paste0("$h_l=" , NA, "$"), "", ""), #remove this
