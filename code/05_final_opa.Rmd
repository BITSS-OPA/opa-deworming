...
baird no ex  = NPV(benef = tax * baird_no_ex, costs = baird_no_ex)  
baird yes ex = NPV(benef = tax * baird_yes_ex, costs = baird_yes_ex)

ea0 no ex  = NPV(benef = baird_no_ex, costs = baird_no_ex)  
ea0 yes ex = NPV(benef = baird_yes_ex, costs = baird_yes_ex)

klps4 no ex  = NPV(benef = tax * klps4_no_ex, costs = baird_no_ex)  
klps4 yes ex = NA  

ea tax no ex  = NPV(benef = tax * baird_no_ex,  costs = ea)  
ea tax yes ex = NPV(benef = tax * baird_yes_ex, costs = ea)
...
- **NPV without externalities in Baird et al, 2016 ($\lambda_2 = 0$):** `r round(res_npv_no_ext_pe,1)`    

- **NPV with externalities in Baird et al, 2016 ($\lambda_2 = `r round(lambda2_so,2)`$ ):** `r round(res_npv_yes_ext_pe,1)`

- **NPV without externalities in EA 2019 ($\lambda_2 = 0$):** `r round(res_npv_no_ext_ea,1)`    

- **NPV with externalities in EA 2019 ($\lambda_2 = `r round(lambda2_so,2)`$ ):** `r round(res_npv_yes_ext_ea,1)`

- **NPV without externalities in KLPS 2019:** `r round(res_npv_no_ext_klps,1)`    
