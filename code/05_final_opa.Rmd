...
table_1[11,1] <- paste0("$\\overline{{N}_{i}}=", round(mean(costs_data$total)), "$")
...
npv_sim_all <-   sim_data1_f(
            ...
            lambda1_var2_sd         = lambda1_sd_so   ,                                          
            lambda2_var2            = lambda2_so      ,                         
            lambda2_var2_sd         = lambda2_sd_so   ,                      
            ...
            q_zero_var2_sd          = 0.001, #q_zero_so * 0.1     BIG CHANGE    , 
            ...
            prevalence_0_var2_sd    = 0.1    ,
            prevalence_r_var2       = 1       ,    #TEMP
            prevalence_r_var2_sd    = 0.1    ,           
            new_prev_r_var2         = round(prevalence_r_in,2), #asd #new_prevalence_r_so,  BIG CHANGE
            new_prev_r_var2_sd      = 0.1,                      #asd #new_prevalence_r_so * 0.1,
            ...
            new_costs_var2_sd       = round(costs2_ea_in,2) * 0.1, #costs2_ea_in * 0.1,
...
plot1 <- generate_plot_f(npv_sim_all, "A3. All income of A2. Main Policy Estimate", rescale_so)[[1]] + 
      labs(y = NULL,
