...
table_1[1,2] <- paste0("$p=" , saturation_in_f(coverage_var = coverage_so, q_full_var = q_full_so, q_zero_var = q_zero_so), "$") # round
table_1[2,2] <- paste0("$R=" , coverage_so, "$") # round
table_1[3,2] <- paste0("$\\lambda_1=" , lambda1_in_f(lambda1_var = lambda1_so)[1], "$")
table_1[4,2] <- paste0("$\\lambda_2=" , lambda2_so, "$")

table_1 <-rbind(table_1, 
                c( "", paste0("$\\hat{\\beta}_1=" , coef_exp_so[1], "$"), ""), # round 
                c( "", paste0("$\\hat{\\beta}_2=" , coef_exp_so[2], "$"), "") ) # round

table_1[5,1] <- paste0("$w_{ww}=" , wage_ww_so, "$") # round
