...
<tbody>
  ...
  <tr>
   <td style="text-align:left;">  </td>
   <td style="text-align:left;"> $\overline{{C}_{i}}=NA$ </td>
   <td style="text-align:left;">  </td>
  </tr>
  <tr>
   <td style="text-align:left;">  </td>
   <td style="text-align:left;"> $\overline{{N}_{i}}=NA$ </td>
   <td style="text-align:left;">  </td>
  </tr>
  <tr>
   <td style="text-align:left;">  </td>
   <td style="text-align:left;"> $\lambda^{eff}_{1}=NA$ </td>
   <td style="text-align:left;">  </td>
  </tr>
</tbody>
</table>
...
<tbody>
  ...
  <tr>
   <td style="text-align:left;">  </td>
   <td style="text-align:left;"> $F_{0}=NA$ </td>
   <td style="text-align:left;">  </td>
  </tr>
</tbody>
</table>
...
```
## Called from: costs1_p1_f()
## debug at <text>#64: costs_data <- country_cost %>% left_join(c_weights, by = "Country") %>% 
##     mutate(per_cap = costs_by_country/total)
## debug at <text>#68: return(costs_data)
```
...
```
## Called from: costs1_p1_f(df_costs_var = df_costs_so, df_costs_cw_var = df_costs_cw_so, 
##     df_counts_var = df_counts_so, staff_time_var = x)
## debug at <text>#64: costs_data <- country_cost %>% left_join(c_weights, by = "Country") %>% 
##     mutate(per_cap = costs_by_country/total)
## debug at <text>#68: return(costs_data)
## Called from: costs1_p1_f(df_costs_var = df_costs_so, df_costs_cw_var = df_costs_cw_so, 
