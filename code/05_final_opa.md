...
<tbody>
  ...
  <tr>
   <td style="text-align:left;"> $E_t=0$ </td>
   <td style="text-align:left;"> $\overline{\Delta \overline{E}_{t}(S1,S2)}=1.5$ </td>
   <td style="text-align:left;">  </td>
  </tr>
  <tr>
   <td style="text-align:left;"> $\alpha^{KLPS3}=82.99$ </td>
