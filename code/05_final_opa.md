...
sim.data1 <- function(nsims = 1e2,
    ...
    gov_bonds_new_sim <-    rnorm(n = nsims, mean = gov_bonds_new_var2, sd = gov_bonds_new_var2_sd)  #rev
    inflation_new_sim <-    rnorm(nsims, inflation_new_var2, inflation_new_var2_sd)                  #rev
...
npv_sim_all <-   sim.data1(nsims = nsims_so,                        
            ...
            teach_sal_new_var2      = teach_sal_new_so         ,                                          
            teach_sal_new_var2_sd   = teach_sal_new_so * 0.1      ,                                       
            teach_ben_new_var2      = teach_ben_new_so         ,                                          
            teach_ben_new_var2_sd   = 0.000001      , 
