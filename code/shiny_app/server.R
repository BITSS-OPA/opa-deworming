...
shinyServer( function(input, output, session) {
  ...
  reactive.data1 <- reactive( {
    sim.data1(
      ...
      gov_bonds_new_var2    = as.numeric(input$param2),    #TEMP                                                                  
      gov_bonds_new_var2_sd = as.numeric(input$param2_1),                                                            
      inflation_new_var2    = as.numeric(input$param3),                                
      inflation_new_var2_sd = as.numeric(input$param3_1), 
