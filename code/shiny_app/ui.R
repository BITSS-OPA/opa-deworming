                   ...
                   fluidRow(id = "tPanel1",style = "overflow-y:scroll; max-width: 400px; max-height: 400px; position:relative;",
                            tabsetPanel(
                              ...
                              tabPanel("Data",
                                       ...
                                       hidden(div(id="SD5",
                                                  sliderInput("param4_1", label = "SD = ", min = 0.0000001* wage_ag_so, max = 1 * wage_ag_so, value = 0.1 * wage_ag_so))),
                                       numericInput("param5", label = "Work-non ag-Wages  (\\( w_{ww} \\))", value = wage_ww_so),
                                       hidden(div(id="SD6",
                                                  sliderInput("param5_1", label = "SD = ", min = 0.0000001* wage_ww_so, max = 1 * wage_ww_so, value = 0.1 * wage_ww_so))),
                                       numericInput("param6", label = "Profits se = ", value = profits_se_so),
                                       hidden(div(id="SD7",
                                                  sliderInput("param6_1", label = "SD = ", min = 0.000001* profits_se_so, max = 1 * profits_se_so, value = 0.1 * profits_se_so))),
                                       ...
                                       sliderInput("param16", label = "Costs of T (local $) = ", step = 0.0001, min = unit_cost_local_so / 2, max = 2 * unit_cost_local_so,
                                                   value = unit_cost_local_so, pre = "$", animate = animationOptions(interval = 3000, loop = TRUE)),
                                       hidden(div(id="SD16", 
                                                  sliderInput("param16_1", label = "SD = ", min = 0.000001* unit_cost_local_so, max = 1 * unit_cost_local_so, value = 0.1 * unit_cost_local_so, step = 0.0001))),
                                       sliderInput("param16_new", label = "Costs of T (local $) = ", step = 0.0001, min = unit_cost_2017usdppp_so / 2, max = 2 * unit_cost_2017usdppp_so,
                                                   value = unit_cost_2017usdppp_so, pre = "$", animate = animationOptions(interval = 3000, loop = TRUE)),
                                       hidden(div(id="SD17", 
                                                  sliderInput("param16_1_new", label = "SD = ", min = 0.000001* unit_cost_2017usdppp_so, max = 1 * unit_cost_2017usdppp_so, value = 0.1 * unit_cost_2017usdppp_so, step = 0.0001))),
                              ...
                              tabPanel("Guesswork",
                                       ...
                                       hidden(div(id="SD33",
                                                  sliderInput("param22_1", label = "SD = ", min = 0.00000001* teach_sal_so, max = 1 * teach_sal_so, value = 0.1 * teach_sal_so))),
                                       numericInput("param23", label = "Teacher benefits = ", value = teach_ben_so),
                                       hidden(div(id="SD34",
                                                  sliderInput("param23_1", label = "SD = ", min = 0.0000001* teach_ben_so, max = 1 * teach_ben_so, value = 0.1 * teach_ben_so))),
                                       numericInput("param24", label = "Students per teacher = ", value = n_students_so),
                                       hidden(div(id="SD35",
                                                  sliderInput("param24_1", label = "SD = ", min = 0.0000001* n_students_so, max = 1 * n_students_so, value = 0.1 * n_students_so))),
