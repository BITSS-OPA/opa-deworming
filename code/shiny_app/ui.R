                   ...
                   fluidRow(id = "tPanel1",style = "overflow-y:scroll; max-width: 400px; max-height: 400px; position:relative;",
                            tabsetPanel(
                              ...
                              tabPanel("Research",
                                       ...
                                       numericInput("param18_1_1", label = h3("sd (\\( \\sigma \\)) = "), value = 0.17),
                                       numericInput("param18_2", label = h3("Lambda 1_f = "), value = lambda1_so[2]),
                                       numericInput("param18_2_1", label = h3("sd (\\( \\sigma \\)) = "), value = 0.17),
                                       sliderInput("param19", label = "Lambda 2 = ",
                                                   min = 0, max = 2 * lambda2_so, value = lambda2_so * 1),
                                       sliderInput("param19_1", label = "SD (\\( \\sigma \\)) = ",
                                       ...
                                       sliderInput("param20_1", label = "SD (\\( \\sigma \\)) = ",
                                       ...
                                       sliderInput("param28_1", label = "SD (\\( \\sigma \\)) = ",
                                       ...
                                       sliderInput("param26_1", label = "SD (\\( \\sigma \\)) = ",
                                       ...
                                       sliderInput("param27_1", label = "SD (\\( \\sigma \\)) = ",
                                                   min = 0.0000001, max = 4, value = delta_ed_ext_par_so * 0.1),
                                       numericInput("param29_1", label = "Lambda 1_1_new = ", value = lambda1_new_so[1]),
                                       numericInput("param29_1_1", label = "sd (\\( \\sigma \\)) = ", value = lambda1_new_sd_so[1]),
                                       numericInput("param29_2", label = "Lambda 1_2_new = ", value = lambda1_new_so[2]),
                                       numericInput("param29_2_1", label = "sd (\\( \\sigma \\)) = ", value = lambda1_new_sd_so[2]),
                                       numericInput("param29_3", label = "Lambda 1_3_new = ", value = lambda1_new_so[3]),
                                       numericInput("param29_3_1", label = "sd (\\( \\sigma \\)) = ", value = lambda1_new_sd_so[3]),
                                       sliderInput("param30", label = "Prevalence in original study (\\( \\eta \\)) = ",
                                                   min = 0, max = 1, value = prevalence_0_so),
                                       sliderInput("param30_1", label = "SD (\\( \\sigma \\)) = ",
