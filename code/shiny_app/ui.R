                   ...
                   fluidRow(id = "tPanel1",style = "overflow-y:scroll; max-width: 400px; max-height: 400px; position:relative;",
                            tabsetPanel(
                              ...
                              tabPanel("Data",
                                       ...
                                       numericInput("param4", label = "Agriculture Wages (\\( w_{ag} \\))", value = wage_ag_so),
                                       ...
                                       sliderInput("param8", label = "Agriculture Hours (\\( H_{ag} )\\) = ",
                                       ...
                                       sliderInput("param9", label = "Working Wage Hours (\\( H_{ww} )\\) = ",
                                       ...
                                       sliderInput("param10", label = "Self-Employed Hours (\\( H_{se} )\\) = ",
                              ...
                              tabPanel("Research",
                                       numericInput("param18_1", label = ("Avg DW impact for men (\\( \\lambda_{1m} \\)) = "), value = lambda1_so[1]),
                                       ...
                                       numericInput("param28_1", label = "Avg DW impact from KLPS data (\\(\\lambda_{KLPS1} \\)) = ", value = lambda1_new_so[1]),
                                       numericInput("param28_1_1", label = "SD = ", value = lambda1_new_sd_so[1]),
                                       numericInput("param29_2", label = "Avg DW impact from KLPS data (\\(\\lambda_{KLPS2} \\)) = ", value = lambda1_new_so[2]),
                                       numericInput("param29_2_1", label = "SD = ", value = lambda1_new_sd_so[2]),
                                       numericInput("param29_3", label = "Avg DW impact from KLPS data (\\(\\lambda_{KLPS3} \\)) = ", value = lambda1_new_so[3]),
                                       numericInput("param29_3_1", label = "SD = ", value = lambda1_new_sd_so[3]),
                              ...
                              tabPanel("Guesswork",
                                       ...
                                       numericInput("param21_2", label = ("Coefficients of \\(Xp^{2} \\) (\\( \\beta_{2} \\)) = "), value = coef_exp_so[2]),
