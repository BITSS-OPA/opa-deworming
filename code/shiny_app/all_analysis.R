...
# Run this thing to get the index.html file
rmarkdown::render("01_final_opa.Rmd", encoding=encoding, output_file=file.path("..", 'index.html'))

# generate the all_analysis.R file that goes into the shiny app. 
