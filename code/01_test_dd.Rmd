...
```{r}
#yes externality NPV
npv(delta_ed_male = (delta_ed_ext_vals[,1] + delta_ed_vals[,1]), 
    delta_ed_female = (delta_ed_ext_vals[,1] + delta_ed_vals[,1] ) )

#no externality NPV
npv(lambda2_male = 0, lambda2_female = 0)
```
...
for (i in 1:nsims) {
  ...
  npv_sim[i] <- npv(interest_r = interst_r_val, 
                    ...
                    saturation = saturation_val_aux,
                       tax = tax_val_sim[i], 
                       delta_ed_male = (delta_ed_ext_vals_sim[i,]+delta_ed_vals_sim[i,]), 
                       delta_ed_female = (delta_ed_ext_vals_sim[i,]+delta_ed_vals_sim[i,] ), 
                    q2 = q2_val_aux, 
                    s2 = s2_val_aux)
}
...
- Finish description of last component
- deploy shiny app with one slider.
- 